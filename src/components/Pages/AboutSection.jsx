...
const AboutSection = () => {
    ...
    return (
        <>
            ...
            <Banner title="About Us" pagename="About Us" description="Crafting extraordinary spaces that blend luxury, sustainability, and timeless elegance." bgimage="/assets/media/images/about-banners.jpg" />
